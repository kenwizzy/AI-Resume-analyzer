...
useEffect(() => {
  const loadResume = async() => {
    const resume = await kv.get(`resume:${id}`);
     ...
     //pdf and image files are stored in blobs on puter storage. So we have to convert/read them from blobs to the normal files 
         ...
         <div className='flex flex-row w-full max-lg:flex-col-reverse'>
            ...
            <section className="feedback-section bg-[url('/images/bg-small.svg) bg-cover">
                ...
                {feedback ? (
                    ...
                    <img src="/images/resume-scan-2.gif" className='w-full'/> //w-full takes the full width of the screen
                )}
            </section>
         </div>
    </main>
